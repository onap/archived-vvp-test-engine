...
class Catalog(ABC):
    ...
    class CallHandle:
        ...
        def __init__(self, catalog_resource, response_callback, verify=False):
    ...
    def __init__(self, config_file=None, history=[], **kwargs):
        ...
        for cls in self.__class__.__subclasses__():
            subclass = cls(config_file=config_file, history=self.history, **kwargs)
    ...
    def load(self, item_name, resource_data, verify=False):
        ...
        setattr(self, item_name.lower(), self.CallHandle(resource, self.add_to_history, verify=verify))
